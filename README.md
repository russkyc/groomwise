...
> GroomWise is structured according to the MVVM-S structure and follows SOLID Principles in object-oriented programming

#### 1.1 MVVM-S Structure
...
5. ependency Inversion Principle (DIP): High-level modules should not depend on low-level modules. Instead, both should depend on abstractions. Abstractions should not depend on details. Details should depend on abstractions.
