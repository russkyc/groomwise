...
public class DialogService : IDialogService
{
    ...
    {
        return await CreateReturningDialog(
            messageBoxText,
            caption,
    ...
    public async Task CloseDialogs(INavigationService navigationService)
    {
        await System.Windows.Application.Current.Dispatcher.InvokeAsync(() =>
        {
            ...
            if (navigationService.CurrentWindow is not Window owner) return;
    ...
    private async Task<bool?> CreateReturningDialog(
        string messageBoxText,
        string caption,
    ...
    private async Task CreateNonReturningDialog(ModernWindow view, INavigationService navigationService)
    {
        await System.Windows.Application.Current.Dispatcher.InvokeAsync(() =>
        {
            if (
